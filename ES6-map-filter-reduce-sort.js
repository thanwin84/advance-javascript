...
//   console.table(oldest);
  ...
  total = inventors.reduce((total, inventor) => {
    total += inventor.passed - inventor.year;
    return total;
  }, 0)
  // var total = inventors.reduce((total, inventor) => total += (inventor.passed - inventor.year), 0);

  // 5. Sort the inventors by years lived
  var sort_by_alive_time = inventors.sort((a, b) => {
    const firstGuy = a.passed - a.year;
    const nextGuy = b.passed - b.year;
    return firstGuy > nextGuy ? 1: -1;
  })
  // console.table(sort_by_alive_time);
